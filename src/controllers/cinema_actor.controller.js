...
const addActorsOnCinema = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: 'Actors added successfully from Cinema' })
  } catch (err) {
...
const editActorOnCinema = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: 'Actor edit successfully from Cinema' })
  } catch (err) {
...
const deleteActorsOnCinema = async (req, res) => {
  ...
  try {
    ...
    res.status(200).json({ message: 'Actors deleted successfully from Cinema' })
  } catch (err) {
